...
/**
 * MemberMapper (정적 CRUD) - SELECT/INSERT/UPDATE/DELETE - 복잡한 검색/페이징은 XML로 분리 가능
 */
@Mapper
public interface MemberMapper {
	...
	/**
	 * 등록(INSERT) — DEFAULT 컬럼은 Service에서 값 보정 - DDL: member_joindate DATE DEFAULT
	 * SYSDATE NOT NULL - 따라서 INSERT 목록에 member_joindate 를 넣지 않는다(기본값 사용)
	 */

	/*
	 * SWAGGER 등록 예시 { "memberId": "hong99", "memberPw": "asd123!@#", "memberName":
	 * "홍길동", "memberGender": "f", "memberEmail": "hong99@example.com",
	 * "memberMobile": "010-1111-2222", "memberPhone": "031-4131-9876", "zip":
	 * "08395", "roadAddress": "서울특별시 구로구 새말로9길 45", "jibunAddress":
	 * "서울특별시 구로구 구로동 123-45", "detailAddress": "101동 100호", "memberBirthday":
	 * "1995-01-01", "memberManipay": "account", "memberRole": "user", "adminType":
	 * "관리자" }
	 * 
	 */
	...
	@Update("""
			    UPDATE member_tbl
			       SET member_pw       = #{memberPw},
			           ...
			           member_email    = #{memberEmail},
			           member_mobile   = #{memberMobile},
			           member_phone    = #{memberPhone,jdbcType=VARCHAR},  -- ✅ 여기에 추가
			           zip             = #{zip,jdbcType=CHAR},
			           ...
			           member_manipay  = #{memberManipay,jdbcType=VARCHAR},
